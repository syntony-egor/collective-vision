const slides = [
  ...
  // Step 1
  { type: "step-intro", step: 1, name: "Яблоко", description: "Одно яблоко на ветке. Десять существ. Каждое уверено, что видит его таким, какое оно есть." },
  ...
  { type: "text", text: "Десять существ. Один объект.\nНи одного яблока — пока кто-то не посмотрит." },

  // Step 2
  { type: "step-intro", step: 2, name: "Комната", description: "Та же комната. Пять существ. Пять разных комнат." },
  ...
  // Step 3
  { type: "step-intro", step: 3, name: "Лицо", description: "Фотоны прилетают в глаз. На выходе — «Маша улыбается». Что произошло между?" },
  ...
  { type: "text", text: "Лицо — не вход. Лицо — продукт.\nНи на одном из шести слоёв нет Маши." },

  // Step 4
  { type: "step-intro", step: 4, name: "Наблюдатель", description: "Пятеро за столом. Одна сцена. Шесть раз." },
  ...
  { type: "text", text: "Ничего не изменилось за столом.\nКаждая версия — честная. Каждая — твоя проекция." },

  // Step 5
  { type: "step-intro", step: 5, name: "Поворот", description: "" },
  { type: "text", text: "смотрю. не вижу. жду." },
];
